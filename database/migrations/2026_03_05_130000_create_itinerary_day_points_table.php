...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('itinerary_day_points', function (Blueprint $table) {
            ...
            $table->foreignId('start_accommodation_id')->nullable()->constrained('accommodations')->nullOnDelete();
            $table->string('end_point_type', 30)->nullable();
            $table->foreignId('end_airport_id')->nullable()->constrained('airports')->nullOnDelete();
            $table->foreignId('end_accommodation_id')->nullable()->constrained('accommodations')->nullOnDelete();
            $table->timestamps();
