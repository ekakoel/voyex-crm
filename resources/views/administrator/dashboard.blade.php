...
@php
    $systemKpis = [
        ['label' => 'Users', 'value' => $systemManagementStats['users'] ?? 0, 'icon' => 'users', 'color' => 'sky', 'route' => 'users.index'],
        ['label' => 'Roles', 'value' => $systemManagementStats['roles'] ?? 0, 'icon' => 'user-shield', 'color' => 'violet', 'route' => 'roles.index'],
        ['label' => 'Modules On', 'value' => $systemManagementStats['modules_enabled'] ?? 0, 'icon' => 'toggle-on', 'color' => 'emerald', 'route' => 'services.index'],
        ['label' => 'Modules Off', 'value' => $systemManagementStats['modules_disabled'] ?? 0, 'icon' => 'toggle-off', 'color' => 'rose', 'route' => 'services.index'],
    ];
    $operationalKpis = [
        ['label' => 'Customers', 'value' => $operationalStats['customers'] ?? 0, 'icon' => 'address-book', 'color' => 'indigo'],
        ['label' => 'Inquiries', 'value' => $operationalStats['inquiries'] ?? 0, 'icon' => 'circle-question', 'color' => 'amber'],
        ['label' => 'Quotations', 'value' => $operationalStats['quotations'] ?? 0, 'icon' => 'file-lines', 'color' => 'teal'],
        ['label' => 'Bookings', 'value' => $operationalStats['bookings'] ?? 0, 'icon' => 'calendar-check', 'color' => 'cyan'],
    ];
    $masterDataKpis = [
        ['label' => 'Vendors', 'value' => $masterDataStats['vendors'] ?? 0, 'icon' => 'handshake', 'route' => 'vendors.index'],
        ['label' => 'Destinations', 'value' => $masterDataStats['destinations'] ?? 0, 'icon' => 'map-location-dot', 'route' => 'destinations.index'],
        ['label' => 'Activities', 'value' => $masterDataStats['activities'] ?? 0, 'icon' => 'person-hiking', 'route' => 'activities.index'],
        ['label' => 'Accommodations', 'value' => $masterDataStats['accommodations'] ?? 0, 'icon' => 'hotel', 'route' => 'accommodations.index'],
        ['label' => 'Transports', 'value' => $masterDataStats['transports'] ?? 0, 'icon' => 'bus', 'route' => 'transports.index'],
        ['label' => 'Attractions', 'value' => $masterDataStats['tourist_attractions'] ?? 0, 'icon' => 'landmark', 'route' => 'tourist-attractions.index'],
        ['label' => 'F&B', 'value' => $masterDataStats['food_beverages'] ?? 0, 'icon' => 'utensils', 'route' => 'food-beverages.index'],
        ['label' => 'Airports', 'value' => $masterDataStats['airports'] ?? 0, 'icon' => 'plane-departure', 'route' => 'airports.index'],
    ];
@endphp
