@props([
    'title' => __('ui.administrator_dashboard.common.loading'),
    'compact' => false,
])

<div class="space-y-3">
    <div class="dashboard-skeleton-line h-4 w-48"></div>
    <p class="text-[11px] text-slate-500 dark:text-slate-400">{{ __('ui.administrator_dashboard.common.section_loading', ['title' => __($title)]) }}</p>
