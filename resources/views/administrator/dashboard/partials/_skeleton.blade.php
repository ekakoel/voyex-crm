@props([
    'title' => ui_phrase('administrator_dashboard_common_loading'),
    'compact' => false,
])

<div class="space-y-3">
    <div class="dashboard-skeleton-line h-4 w-48"></div>
    <p class="text-[11px] text-slate-500 dark:text-slate-400">{{ ui_phrase('administrator_dashboard_common_section_loading', ['title' => $title]) }}</p>
