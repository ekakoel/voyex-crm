...
<div class="space-y-4">
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('admin.quotation-templates.index') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">Cancel</a>
    </div>
</div>
