...
@php
    $kpiCards = [
        ['label' => 'My Revenue (This Month)', 'value' => $kpis['monthly_revenue'] ?? 0, 'icon' => 'wallet', 'color' => 'emerald', 'format' => 'money'],
        ['label' => 'My Conversion Rate', 'value' => $kpis['conversion_rate'] ?? 0, 'icon' => 'chart-line', 'color' => 'indigo', 'suffix' => '%'],
        ['label' => 'My Active Inquiries', 'value' => $kpis['active_inquiries'] ?? 0, 'icon' => 'circle-question', 'color' => 'sky'],
