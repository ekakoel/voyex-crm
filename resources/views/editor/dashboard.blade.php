...
@php
    $kpiCards = [
        ['label' => 'Destinations', 'value' => $catalogCounts['destinations'] ?? 0, 'icon' => 'map-location-dot', 'color' => 'sky'],
        ['label' => 'Vendors', 'value' => $catalogCounts['vendors'] ?? 0, 'icon' => 'handshake', 'color' => 'teal'],
        ['label' => 'Activities', 'value' => $catalogCounts['activities'] ?? 0, 'icon' => 'person-hiking', 'color' => 'lime'],
        ['label' => 'Accommodations', 'value' => $catalogCounts['accommodations'] ?? 0, 'icon' => 'hotel', 'color' => 'indigo'],
    ];
@endphp
