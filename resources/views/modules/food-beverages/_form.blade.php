...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('Filter only, not stored in service database.') }}</p>
        </div>
        <div>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ ui_phrase('Service Type') }}</label>
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('food-beverages.index') }}"  class="btn-secondary">{{ ui_phrase('Cancel') }}</a>
    </div>
</div>
