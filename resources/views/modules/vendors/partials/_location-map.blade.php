@include('components.location-map-picker', [
    ...
    'iconHtml' => '<span class="location-map-pin__inner"><i class="fa-solid fa-store" aria-hidden="true"></i></span>',
    'successHint' => ui_phrase('Vendor location displayed successfully on the map.'),
