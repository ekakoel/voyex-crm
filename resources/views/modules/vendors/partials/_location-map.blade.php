<div class="space-y-2">
    <h3 class="text-sm font-semibold text-gray-800 dark:text-gray-100">{{ ui_phrase('Location on Map (open map)') }}</h3>
            ...
            function initVendorLocationMap(root = document) {
                ...
                mapElements.forEach((mapElement) => {
                    ...
                    const syncMapMarker = () => {
                        ...
                        setHint('Vendor location displayed successfully on the map.', 'success');
                    };
