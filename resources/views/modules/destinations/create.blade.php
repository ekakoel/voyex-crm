...
@section('page_title', __('ui.modules.destinations.add_destination'))
@section('page_subtitle', __('ui.modules.destinations.create_page_subtitle'))
        ...
        <div class="module-grid-8-4">
            <div class="module-grid-main">
                <div class="module-form-wrap">
                    <form method="POST" action="{{ route('destinations.store') }}">
                        @csrf
                        @include('modules.destinations._form', ['buttonLabel' => __('ui.modules.destinations.save_destination')])
                    </form>
                </div>
            </div>
            <aside class="module-grid-side">
                <div class="module-card p-5 text-sm text-slate-600 dark:text-slate-300">
                    ...
                    <p class="mt-2">{{ __('ui.modules.destinations.info_text') }}</p>
                </div>
            </aside>
        </div>
    </div>
