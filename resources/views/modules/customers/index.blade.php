                    ...
                    @forelse ($customerRows as $row)
                        ...
                        <div class="app-card relative p-4 pt-5">
                            ...
                            <div class="flex items-start gap-3 pr-12">
                                <div class="min-w-0">
                                    <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">{{ $row['name'] }}
                                    </p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">{{ $row['code'] }} -
                                        {{ $row['email'] }}</p>
                                </div>
                                <span
                                    class="text-xs font-medium rounded-full bg-gray-100 px-2 py-0.5 text-gray-700 dark:bg-gray-900/40 dark:text-gray-300">{{ $row['customer_type_label'] }}</span>
                            </div>
