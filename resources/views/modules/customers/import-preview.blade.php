                    ...
                    @forelse ($rows as $row)
                        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <div class="mt-3 grid grid-cols-2 gap-2 text-xs text-gray-600 dark:text-gray-300">
                                <div>Code</div><div>{{ $row['data']['code'] ?? '-' }}</div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse ($rows as $row)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-gray-700 dark:text-gray-200">{{ $row['data']['customer_type'] ?? '-' }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-4 py-6 text-center text-sm text-gray-500 dark:text-gray-400">No preview data available.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
