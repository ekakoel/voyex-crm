...
<div class="space-y-4" data-location-autofill data-location-resolve-url="{{ route('location.resolve-google-map') }}">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ ui_phrase('Ideal Visit Duration (minutes)') }}</label>
            <input
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('tourist-attractions.index') }}"  class="btn-secondary">{{ ui_phrase('Cancel') }}</a>
    </div>
</div>
