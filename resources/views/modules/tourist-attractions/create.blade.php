...
@section('page_title', ui_phrase('attractions create page title'))
@section('page_subtitle', ui_phrase('attractions create page subtitle'))
        ...
        <div class="module-grid-8-4">
            <div class="module-grid-main">
                <div class="module-form-wrap">
                    <form method="POST" action="{{ route('tourist-attractions.store') }}" enctype="multipart/form-data">
                        @csrf
                        @include('modules.tourist-attractions._form', ['buttonLabel' => ui_phrase('attractions save attraction')])
                    </form>
                </div>
            </div>
            <aside class="module-grid-side">
                <div class="module-card p-5 text-sm text-slate-600 dark:text-slate-300">
                    ...
                    <p class="mt-2">{{ ui_phrase('attractions info text') }}</p>
                </div>
            </aside>
        </div>
    </div>
