            ...
            <aside class="xl:col-span-3 space-y-3">
                <div class="sa-card p-4">
                    ...
                    <div class="mt-3 space-y-2 text-xs">
                        <div class="sa-mini"><span>{{ ui_phrase('Total Modules') }}</span><b>{{ number_format($totalCount) }}</b></div>
                        <div class="sa-mini"><span>{{ ui_phrase('Enabled') }}</span><b class="text-emerald-600 dark:text-emerald-400">{{ number_format($enabledCount) }}</b></div>
                        <div class="sa-mini"><span>{{ ui_phrase('Disabled') }}</span><b class="text-rose-600 dark:text-rose-400">{{ number_format($disabledCount) }}</b></div>
                    </div>
                </div>
