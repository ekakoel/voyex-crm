...
@section('content')
    <div class="max-w-3xl space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 space-y-4">
            <form method="POST" action="{{ route('sales.customers.import.preview') }}" enctype="multipart/form-data">
                @csrf
                <div class="flex items-center justify-between">
                    <p class="text-sm text-gray-600 dark:text-gray-300">Download the CSV template for the standard format.</p>
                    <a href="{{ route('sales.customers.import.template') }}" class="rounded-lg border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
                        Download Template
                    </a>
                </div>
                <div>
                ...
                <div class="rounded-lg border border-dashed border-gray-300 p-4 text-sm text-gray-600 dark:border-gray-600 dark:text-gray-300">
                    ...
                    Header opsional: <code>email, phone, address, customer_type, company_name</code><br>
