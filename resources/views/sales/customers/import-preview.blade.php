...
@section('content')
    <div class="space-y-6">
        ...
        <div class="hidden md:block overflow-x-auto rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-6 text-center text-sm text-gray-500 dark:text-gray-400">No data available.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <form method="POST" action="{{ route('sales.customers.import.store') }}">
            @csrf
